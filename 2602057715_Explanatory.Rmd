...
map_plot <- ggplot() +
  ...
  ggtitle("Country Locations with Deaths") +
  theme_void()
...
bar_plot <- ggplot(data, aes(x = state, y = num_driving_deaths)) +
  ...
  xlab("State") +
  ylab("Death Number") +
  ggtitle("Comparison of Death Numbers by State") +
...
#3. num of firearm fatality
bar_plot <- ggplot(data, aes(x = state, y = num_firearm_fatalities)) +
  geom_bar(stat = "identity", fill = "lightblue") +
  xlab("State") +
  ylab("Death Number") +
  ggtitle("Comparison of Death Numbers by State") +
